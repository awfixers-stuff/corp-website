      ...
      tabs: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                description:
                  "Contributions to AWFixer's Stuff. Must be a valid GitHub issue, pull request, or discussion URL from a repo in the 'payloadcms' organization.",
              },
              fields: [
                {
                  type: 'row',
                  fields: [
                    ...
                    },
                    {
                      ...
                      admin: {
                        width: '25%',
                        // description: ({ path, value }) => `github.com/awfixers-stuff/${value || ''}`,
                      },
                      defaultValue: 'docs',
                      required: true,
                    },
