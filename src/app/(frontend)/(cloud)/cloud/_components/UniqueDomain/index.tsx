...
// `initialValue` includes the `.website.app` suffix, so we need to strip that off
export const UniqueDomain: React.FC<{
  ...
  const initialSubdomain = useRef<string | undefined>(initialValue?.replace('.website.app', ''))
